...
/**
 * @version $Id: PreTime.java 1765 2007-08-04 04:14:28Z tdsoul $
 */
    ...
    public void actionPerformed(Event event) {
        ...
        try {
            if (dfe.getCommand().startsWith("MKD")) {
                ...
                _irc.getIRCConnection().sendCommand(new MessageCommand(
                        getPreBot(), "!pred " + releaseName));
            }
            ...
            if (msgc.getSource().getNick().equals(_parent.getPreBot())) {
                if (msgc.isPrivateToUs(_irc.getIRCConnection().getClientState())) {
                    ...
                    if (msg[0].equals("!preds")) {
                        ...
                        String time = "-=PRETiME=- " + releaseName +
                            " was pred ";
