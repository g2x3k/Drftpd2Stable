 ...
 *
 * @author mog
 * @version $Id: Bytes.java 1765 2007-08-04 04:14:28Z tdsoul $
 */
public class Bytes {
    ...
    public static String formatBytes(long bytes, boolean binary) {
        ...
        for (int i = 0; i < MULTIPLES.length; i++) {
            ...
            long multipleVal = binary ? multiple.getBinaryMultiple()
    ...
    public static long parseBytes(String str) throws NumberFormatException {
        ...
        for (int i = 0; i < MULTIPLES.length; i++) {
            ...
            if (suffix == multiple.getSuffix()) {
                return Long.parseLong(str) * (binary
                ? multiple.getBinaryMultiple() : multiple.getMultiple());
            }
        }
