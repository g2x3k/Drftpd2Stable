 ...
 * @author mog
 * @author zubov
 * @version $Id: Slave.java 1761 2007-08-03 00:13:36Z tdsoul $
 */
public class Slave {
    ...
    public static final String VERSION = "DrFTPD+ 2.0 (+STABLE+) $Revision: 1761 $";
    ...
    public Slave(Properties p) throws IOException {
        ...
        try {
        	...
        	_portRange = new PortRange(minport, maxport, getBufferSize());
        } catch (NumberFormatException e) {
        	_portRange = new PortRange(getBufferSize());
        }
    }
